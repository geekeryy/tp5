<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"H:\Git\phpproject\thinkphp_5.0.10_full\public/../application/index\view\index\bindphone.html";i:1501936572;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
//向后台发送处理数据
	$.ajax({
		...
		url: "<?php echo url('Main/send_message'); ?>", //目标地址
		data: {"phones":phone},
...
<body>
	...
	<form class="am-form" action="<?php echo url('Main/bindPhone'); ?>">
