<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"H:\Git\phpproject\thinkphp_5.0.10_full\public/../application/index\view\index\bindphone.html";i:1502351287;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
...
<body>
	...
	<form class="am-form" action="<?php echo url('User/bindPhone'); ?>" method="post">
