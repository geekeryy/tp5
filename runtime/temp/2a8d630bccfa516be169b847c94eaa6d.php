<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:91:"H:\Git\phpproject\thinkphp_5.0.10_full\public/../application/index\view\index\register.html";i:1501914344;}*/ ?>
<!doctype html>
<html class="no-js">
<head>
  <meta charset="utf-8">
	...
	<form class="am-form">
	  <fieldset class="myapp-login-form am-form-set">
		<div class="am-form-group am-form-icon">
			...
			<input type="text" class="myapp-login-input-text am-form-field" name="account" placeholder="请输入您的账号">
		</div>
	    <div class="am-form-group am-form-icon">
			<i class="am-icon-lock"></i>
			<input type="text" class="myapp-login-input-text am-form-field" name="passwd" placeholder="请输入密码">
		</div>
		<div class="am-form-group am-form-icon">
			<i class="am-icon-lock"></i>
			<input type="text" class="myapp-login-input-text am-form-field" name="repasswd" placeholder="请确认密码">
		</div>
	  </fieldset>
